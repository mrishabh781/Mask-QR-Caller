...
export default function AboutPage() {
  ...
  return (
    <div className={`py-8 relative ${clsx({ 'top-16': isMobile, 'top-0': !isMobile })}`}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
        <h2 className="text-3xl font-semibold text-indigo-600">QRMaskCaller</h2>
          <p className="mt-2 text-3xl font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl">
            The idea behind QRMaskCaller is to ensure your privacy while dealing with outside world scenarios.
          </p>
